<section id="how-it-works" class="py-20 px-4 bg-gray-50">
    <div class="max-w-2xl mx-auto">
        ...
        <ol class="relative space-y-0">
            ...
            @php
            $steps = [
                ['num' => '1', 'title' => 'Заповніть форму на сайті',                           'desc' => 'Вкажіть тип роботи, ваш ВИШ і зручний спосіб зв\'язку', 'delay' => ''],
                ['num' => '2', 'title' => 'Зв\'яжемось у Telegram протягом 1–2 годин',          'desc' => 'Відповідаємо у робочий час: 10:00–20:00 за Києвом',        'delay' => 'delay-150'],
                ['num' => '3', 'title' => 'Узгодимо деталі, ціну і термін',                     'desc' => 'Ціна залежить від обсягу роботи та терміновості',          'delay' => 'delay-300'],
                ['num' => '4', 'title' => 'Отримаєте оформлену роботу в обумовлений час',       'desc' => 'Надішлемо готовий файл у Telegram або на пошту',           'delay' => 'delay-500'],
            ];
            @endphp
